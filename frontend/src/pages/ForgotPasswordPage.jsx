      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        <div style={{ background: 'white', borderRadius: 28, padding: '40px 40px', boxShadow: '0 8px 40px rgba(0,0,0,0.08)', border: '1px solid #f1f5f9' }}>
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            ...
            <h1 style={{ fontSize: 24, fontWeight: 800, color: '#0f172a', marginBottom: 6 }}>비밀번호 찾기</h1>
            <p style={{ fontSize: 14, color: '#94a3b8' }}>가입한 이메일로 재설정 링크를 보내드려요</p>
          </div>

          {sent ? (
            <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: 12, padding: '18px 16px', fontSize: 14, color: '#166534', textAlign: 'center', lineHeight: 1.6 }}>
        ...
        <div style={{ textAlign: 'center', marginTop: 20 }}>
          <Link to="/login" style={{ fontSize: 14, color: '#059669', fontWeight: 600, textDecoration: 'none' }}>
            로그인으로 돌아가기
          </Link>
        </div>
      </div>
