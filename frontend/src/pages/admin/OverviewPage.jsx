...
const s = {
  ...
  kpiValue: { fontSize: 30, fontWeight: 700, color: '#10b981', marginBottom: 4 },
  ...
  cardHeading: { fontSize: 15, fontWeight: 700, color: '#0f172a', marginBottom: 16 },
  ...
  roleCount: { padding: '8px 0', textAlign: 'right', fontWeight: 600, color: '#0f172a' },
